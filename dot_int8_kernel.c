...
dot_int8_kernel(int32_t* output,
  ...
  asm volatile (
    ...
    "//vwredsum.vs v8, v12, v0                    \n"
    ".word 0b0011000110110000000000010001010111   \n"
    "//vwredsum.vs v12, v16, v0                   \n"
    ".word 0b0011000111000000000000011001010111   \n"
    "//vwredsum.vs v16, v20, v0                   \n"
    ".word 0b0011000111010000000000100001010111   \n"
    /// store
    "//vmv.x.s    t4, v4                          \n"
    ".word 0b00000110010010000000010111011010111  \n"
    "//sw          t4, 0(%[outw])                 \n"
    ".word 0x01d52023                             \n"
    "//addi         %[outw], %[outw], 4           \n"
    ".half 0x0511                                 \n"
    "//vmv.x.s    t4, v8                          \n"
    ".word 0b00000110010100000000010111011010111  \n"
    "//sw          t4, 0(%[outw])                 \n"
    ".word 0x01d52023                             \n"
    "//addi         %[outw], %[outw], 4           \n"
    ".half 0x0511                                 \n"
    "//vmv.x.s    t4, v12                         \n"
    ".word 0b00000110010110000000010111011010111  \n"
    "//sw          t4, 0(%[outw])                 \n"
    ".word 0x01d52023                             \n"
    "//addi         %[outw], %[outw], 4           \n"
    ".half 0x0511                                 \n"
    "//vmv.x.s    t4, v16                         \n"
    ".word 0b00000110011000000000010111011010111  \n"
    "//sw          t4, 0(%[outw])                 \n"
    ".word 0x01d52023                             \n"
    ::
      [data] "r" (data),
